...
struct ExcludeAppPreferenceView: View {
    ...
    @State private var applications: [AppInfo] = AppState.shared.excludeAppService.applications
    ...
    private func addApplication() {
        ...
        for url in openPanel.urls {
            ...
            guard let appInfo = AppInfo(info: info as [String: AnyObject]) else { continue }
